# p10displaywithrs485tottlcontrollerwithprotocol. the rs485 to ttl module is connected with arduino. ttl rx pin is connected to arduino tx pin and ttl tx pin is connected to arduino rx pin
